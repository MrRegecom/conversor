# streamlit_app.py — dark fixo + fundo full-bleed + etapas + botão verde + footer fixo no canto
...
# ============== Aparência (dark fixo) ==============
PRIMARY = "#915eff"
BG, PANEL, BORDER, TEXT, MUTED = "#0f1117", "#141a27", "rgba(255,255,255,.12)", "#f5f7ff", "#a9b1c3"
BADGE_WAIT, BADGE_DONE, INPUT_BG = "#515a72", "#22c55e", "#0f1117"
...
/* Fundo ESCURO em tudo, inclusive bordas laterais */
html, body, .stApp, .stAppViewContainer, .main, .block-container {{
  background: var(--bg) !important; color: var(--text);
}}
.block-container {{max-width: 1100px; padding-top: .6rem; padding-bottom: 70px;}}
...
.fixed-footer {{
  ...
  text-align:right; color: var(--muted); line-height: 1.15; font-size:.95rem;
...
# ===== Footer fixo (canto inferior direito) =====
st.markdown("""
